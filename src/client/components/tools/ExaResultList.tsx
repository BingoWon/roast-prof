		...
		<div className="flex flex-col gap-1.5">
			{visible.map((res) => (
				<a
					...
					className="group flex items-start gap-2 px-2.5 py-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-white/5 transition-colors"
				>
			...
			{hasMore && (
				<button
					...
					className="flex items-center justify-center gap-1 py-1 text-[10px] text-zinc-400 dark:text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-400 transition-colors cursor-pointer"
				>
					{expanded ? (
						<>
